...
Base inventory items are created by default.
*/
...
Inventory::Inventory()
{
	...
	inventoryItems[4] = InventoryItem("Celery", "Produce", "Cel-er-ee LLC", 10.13, true);
...
Displays the full inventory list to be viewed by the customer for cart additions.
